...
<input ID ="email" runat ="server" ClientIDMode="static" type ="text" required value="Email" >
<br />
 <br />
<asp:Label runat ="server" Text ="password"></asp:Label>
<input ID ="password"   runat ="server" ClientIDMode="static" type="password" required value="Password" >&nbsp;
<br />
<br />
<br />

...
<body>
    <form id="form1" runat="server">
        <div class ="register">
            ...
            <asp:TextBox required="required" height ="20px" width ="240px" ID="thSerial" runat="server" pattern="[0-9]"></asp:TextBox>
            <br />
            <br />
            ...
            <asp:TextBox required="required" height ="20px" width ="240px" ID="NoInstall" runat="server" pattern="[0-9]"></asp:TextBox>
            <br />
            <br />

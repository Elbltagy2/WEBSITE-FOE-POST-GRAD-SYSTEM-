...
values(2,'gggg','ddddd','ha','gaaaaa','fafdafaf',3.2,5)
...
insert into Thesis ( field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
values('Engineering','Master','Model validation for an agile UAV', '2017-7-15','2018-8-1','2018-8-15', 85,2,0);
insert into Thesis ( field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
...
insert into Thesis (field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
values('Engineering','Master','Reconfigurable metamaterials for soft robotics', '2018-6-15','2019-2-15','2019-3-1', 70,5,0);
insert into Thesis (field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
...
insert into Thesis (field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
values('Engineering','Master','Multi-robot collaborative state estimation', '2018-6-1','2019-6-1','2019-7-1', 79,8,1);
insert into Thesis (field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
...
insert into Thesis (field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
values('Engineering','Master','Pellet stream propulsion for interstellar flight', '2018-6-1','2019-6-1','2019-7-1', 93,12,0);
insert into Thesis (field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
values('Engineering','Master','Device fabrication for the imaging of protein', '2019-6-1','2020-6-1','2020-7-1', 82,13,0);
insert into Thesis (field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
values('Engineering','PhD','Sailing strategies for improved fuel efficiency', '2018-7-15','2019-6-1','2019-7-15', 89,14,1);
insert into Thesis (field, type, title, startDate, endDate, defenseDate, grade,payment_id,noOfExtensions)
...
insert into GUCianStudentRegisterThesis values (2,3,11)
insert into GUCianStudentRegisterThesis values (2,3,10)
...
exec editexaminer 8 ,null, null

select * from Thesis
insert into e (serialNumber,date)
values(1,'2019-07-01')
select * from Examiner
insert into ExaminerEvaluateDefense(serialNo,date,examinerId)
values(1,'2019-07-01',8)
select * from ExaminerEvaluateDefense
